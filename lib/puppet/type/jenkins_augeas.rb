...
# I added some options etc. I will replace this code later with a rewrite,
...
Puppet::Type.newtype(:jenkins_augeas) do
  include Puppet::Util
  ...
  newparam(:master_key_file_path) do
    desc "Path to the file master.key."
    defaultto "/var/lib/jenkins/secrets/master.key"
  end

  newparam(:hudson_util_secret_file_path) do
    desc "Path to the file hudson.Util.Secret"
    defaultto "/var/lib/jenkins/secrets/hudson.util.Secret"
  end
